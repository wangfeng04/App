...
<script type="text/javascript">
    ...
    function build_rj_table(data) {
        ...
        console.log(data)
        //获取分页信息
        var rj= data.returnDate.rjPageInfo;
        // var rj= data.returnDate.rjPageInfo.list;
        console.log(rj)
        ...
        //     var appSize_td = $("<td></td>").append(item.appSize);
        //     var pintai_td = $("<td></td>").append(item.pintai);
        //     var fenLei_td = $("<td></td>").append(item.onefenLei+"-"+item.twofenlei+"-"+item.threefenli);
        //     var zhuantai_td =$("<td></td>").append(item.zhuantai)
        //     var kaifaze_td = $("<td></td>").append(item.kaifaze);
        ...
        //
        //     //编辑按钮
        //     var edit_btn = $("<button></button>").addClass("btn btn-sm btn-primary edit_btn").attr("data-id",item.id).attr("data-pn",data.returnData.rjPageInfo.pageNum)
        //         .append($("<span></span>").addClass("glyphicon glyphicon-pencil")).append("&nbsp;通过")
        //     //删除按钮
        //     var del_btn = $("<button></button>").addClass("btn btn-sm btn-danger del_btn").attr("data-id",item.id).attr("data-pn",data.returnData.rjPageInfo.pageNum)
        //         .append($("<span></span>").addClass("glyphicon glyphicon-trash")).append("&nbsp;不通过")
        //     //将操作按钮放入操作的td列
    ...
    //     $("#page_pageInfo").empty();
    //     var rjPageInfo = data.returnData.rjPageInfo;
