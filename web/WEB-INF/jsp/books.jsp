...
<div class="container">
    ...
    <table class="table table-hover table-striped">
        ...
        <tr>
            ...
            <td>${book.detail}</td>
            <td>
                <a href="update?id=${book.id}" class="btn btn-primary"><span class="glyphicon glyphicon-pencil">修改</span></a>
                <a href="delet?id=${book.id}" class="btn btn-danger"><span class="glyphicon glyphicon-trash">删除</span></a>
            </td>
        </tr>
        </c:forEach>
    </table>
